...
export class PlayersComponent implements OnInit {
  ...
  dtOptions: any;
  first_name:any;last_name:any;player_jersey_no:any;player_country:any;team_name:any;file:any;
  ...
  addPlayer(){
    this.team_name = this.file = this.first_name = this.last_name = this.player_jersey_no = this.player_country =""
